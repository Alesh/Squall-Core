...
from squall.core.abc import Callable, Coroutine
...
class _ServerSocketStream(IOStream):
...
class _ConnectionManager(AbcSwitcher):
    """ Client connection manager / coroutine switcher
    """
    ...
    def accept(self, socket_: SocketType, address: str):
        ...
        """
        stream = _ServerSocketStream(self._disp, self, socket_,
...
class TCPServer(AbcTCPServer):
    ...
    def __init__(self, stream_handler, block_size=1024, buffer_size=65536):
        ...
        self._connections = None  # type: _ConnectionManager
    ...
    def start(self, num_processes = 1):
        ...
        self._connections = _ConnectionManager(self._disp, *self._cm_args)
